...
/**
 * MobilePlatform - Mobile-specific implementation of PlatformInterface
 */
export class MobilePlatform extends BasePlatform {
  // Piece image paths for mobile
  ...
  public getApiUrl(): string {
    // For Android emulator, we need to use 10.0.2.2 to access the host machine
    return API_URL;
  }

  /**
   * Get a fallback API URL if the primary one fails
   * @returns Fallback API URL
   */
  public getFallbackApiUrl(): string {
...
export const mobilePlatform = new MobilePlatform();
